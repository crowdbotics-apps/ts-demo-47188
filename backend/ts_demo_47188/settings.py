"""
Django settings for ts_demo_47188 project.
...
ROOT_URLCONF = 'ts_demo_47188.urls'
...
WSGI_APPLICATION = 'ts_demo_47188.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ts_demo_47188 API",
    "DESCRIPTION": "API documentation for ts_demo_47188 App",
    "VERSION": "v1",
}
